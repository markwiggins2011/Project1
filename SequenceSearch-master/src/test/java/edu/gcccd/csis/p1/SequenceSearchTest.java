...
public class SequenceSearchTest {
    ...
    public void getLongestTaggedSequence() throws Exception {
        ...
        Assert.assertEquals(0, new SequenceSearchImpl(s, d0, d1).getAllTaggedSequences().length);
    ...
    public void testPresentable() {
        ...
        // See line 20 and 45 in SequenceSearchImp1.java: sequenceList is never populated prior to call for displayStringArray()
